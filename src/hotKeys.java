	...
	public static void checkKeys() {
		...
		if (altprintscreen()) {
			try {
				...
				mainWindow.link = "http://" + mainWindow.hostStr + mainWindow.uploadDir + randomName;
				mainWindow.model.insertRow(0, new Object[] { randomName, fileSize / 1024 + "KB", "<html><a href='" + mainWindow.link + "'>" + mainWindow.link + "</a></html>" });
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
